      ...
      <Canvas>
        ...
        >
            ...
            >
              ...
              onMouseEnter={()=>{this.walletEnter()}}
              onMouseLeave={()=>{this.walletLeave()}}
              ...
              <IconButton uiTransform={{height:buttonSize, width:buttonSize}} 
              onMouseEnter={()=>{this.notificationsEnter()}}
              onMouseLeave={()=>{this.notificationsLeave()}}
              ...
              <UiEntity uiTransform={{height:1, width:'80%'}} uiBackground={{color:SELECTED_BUTTON_COLOR}}/>

              <IconButton uiTransform={{height:buttonSize, width:buttonSize}} 
              onMouseEnter={()=>{this.mapEnter()}}
              ...
              <IconButton uiTransform={{height:buttonSize, width:buttonSize}} 
              onMouseEnter={()=>{this.backpackEnter()}}
              onMouseLeave={()=>{this.backpackLeave()}}
              onMouseDown={()=>{console.log('clicked')}}
              ...
              <IconButton uiTransform={{height:buttonSize, width:buttonSize}} 
              onMouseEnter={()=>{this.settingsEnter()}}
              onMouseLeave={()=>{this.settingsLeave()}}
              onMouseDown={()=>{console.log('clicked')}}
              ...
              <IconButton uiTransform={{height:buttonSize, width:buttonSize}} 
              onMouseEnter={()=>{this.helpEnter()}}
              onMouseLeave={()=>{this.helpLeave()}}
              onMouseDown={()=>{console.log('clicked')}}
              ...
              >
                ...
                <IconButton uiTransform={{height:buttonSize, width:buttonSize}} 
                onMouseEnter={()=>{this.emotesEnter()}}
                onMouseLeave={()=>{this.emotesLeave()}}
                onMouseDown={()=>{console.log('clicked')}}
